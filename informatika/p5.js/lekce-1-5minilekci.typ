#set page(margin: 1cm, height: 21cm, width: 29.7cm)
#columns(3)[
...
* používá alespoň _jeden tvar_*
* reaguje na _myš nebo klávesnici_ *
* obsahuje _alespoň jednu proměnnou_ *

---

*Poznámka:*
Kód zkoušejte v online editoru: 
