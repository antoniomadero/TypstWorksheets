#set page(margin: (top: 1.5cm, left: 2cm, right: 1.5cm, bottom: 2cm))
#set enum(spacing: 3em)
= Pracovní list: Slovní úlohy na nejmenší společný násobek

== Úvod
V tomto pracovním listu si procvičíme řešení slovních úloh, které vyžadují znalost nejmenšího společného násobku (NSN) nebo největšího společného dělitele (NSD). Každá úloha je zpracována tak, aby studenti mohli aplikovat matematické koncepty v praktických situacích.

== Úlohy

+ Dva autobusy odjíždějí ze zastávky. První každých 12 minut, druhý každých 18 minut. \
  Za kolik minut odjedou znovu ve stejný čas?

+ Máme 24 jablek a 36 hrušek. \
  Chceme je rozdělit do co největšího počtu stejných balíčků tak, aby v každém bylo stejně jablek i hrušek. \
  Kolik balíčků můžeme vytvořit?

+ Ve škole zvoní na přestávku každých 45 minut a školník kontroluje chodby každých 30 minut. \
...
+ Ve skladu je 48 krabic sušenek a 60 krabic čokolád. \
  Chceme je rozdělit do co nejvíce stejných balení bez zbytku. \
  Kolik balení lze vytvořit?

+ Filmové představení začíná každých 90 minut, druhé každých 60 minut. \
  Za kolik minut začnou obě představení současně?

+ Máme 18 zelených a 24 žlutých fixů. \
  Chceme je rozdělit do stejných sad bez zbytku. \
  Kolik nejvíce sad lze vytvořit?

+ Jedna tramvaj přijíždí každých 14 minut, druhá každých 21 minut. \
  Za kolik minut přijedou současně?
...
- NSN se používá pro situace, kdy se něco opakuje nebo se dělí do skupin.
- NSD se používá pro nalezení největšího počtu stejných částí bez zbytku.
