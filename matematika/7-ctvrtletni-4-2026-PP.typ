...
#task-box(
  "2",
  [V roce 2020 firma vyrobila 250 výrobků. Jak v roce 2021, tak v roce 2022 vyrobila firma vždy o 20 % výrobků více než v předchozím roce. *_Kolik výrobků vyrobila firma v roce 2022?_*],
  "5",
)
...
#task-box(
  "8",
  [Vypočítej _povrch a objem_ čtyřbokého hranolu s podstavou #underline[kosodélníku] \ (a = 8 cm, b = 4,5 cm, $v_a$ = 4 cm). Výška hranolu $v_h$ = 15 cm.],
  "5",
)
